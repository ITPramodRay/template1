        ...
        <Nav className="myaccountmenu-list" navbar>
          <NavItem>
            <NavLink
              ...
              className={`${
                location.pathname === myProfilePaths.myProfile ? "active" : ""
              }`}
            >
              <img
          ...
          <NavItem>
            <NavLink
              onClick={() => history.push(myProfilePaths.kycDetails)}
              className={`${
                location.pathname === myProfilePaths.kycDetails ? "active" : ""
              }`}
            >
              <img
                src={CircleWavyCheck}
          ...
          <NavItem>
            <NavLink
              onClick={() => history.push(myProfilePaths.bankDetails)}
              className={`${
                location.pathname === myProfilePaths.bankDetails ? "active" : ""
              }`}
            >
          ...
          <NavItem>
            <NavLink
              onClick={() => history.push(myProfilePaths.contactDetails)}
              className={`${
          ...
          <NavItem>
            <NavLink
              onClick={() => history.push(myProfilePaths.nominee)}
              className={`${
                location.pathname === myProfilePaths.nominee ? "active" : ""
              }`}
            >
              <img
                src={UserCirclePlus}
          ...
          <NavItem>
            <NavLink
              onClick={() => history.push(myProfilePaths.referFriend)}
              className={`${
                location.pathname === myProfilePaths.referFriend ? "active" : ""
              }`}
            >
          ...
          <NavItem>
            <NavLink
              onClick={() => history.push(myProfilePaths.preApprovedInsurance)}
              className={`${
