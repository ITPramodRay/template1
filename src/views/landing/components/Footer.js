                    ...
                    <Container >
                        <Row >
                            <Col sm={7}>
                                <Row className="">
                                    <Col sm={4}>
                                        <img src={Footerlogo} alt="" className="img-fluid foooter-logo" />
                                    </Col>
                                    <Col sm={2}>
                                        <Link to="#" className='footer-link'>Dashboard</Link>
                                        <Link to="#" className='footer-link'>Invest</Link>
                                        <Link to="#" className='footer-link'>Advisory</Link>
                                        <Link to="#" className='footer-link'>Plan </Link>
                                        <Link to="#" className='footer-link'>Lean</Link>
                                    </Col>
                                    <Col sm={5}>
                                        <Link to="#" className='footer-link'>Terms & Conditions</Link>
                                        <Link to="#" className='footer-link'>Contact us </Link>
                                        <Link to="#" className='footer-link'>Disclaimers </Link>
                                        <Link to="#" className='footer-link'>Code of conduct</Link>
                                        <Link to="#" className='footer-link'>Wellbeing</Link>
                                    </Col>
                            ...
                            <Col sm={5}>
                                ...
                                <p className='copyright-text'>© Copyright 2021 HDFC Pension - All Rights Reserved</p>
