                                    ...
                                    <Col sm={4}>
                                        <div className="employee-block">
                                            <div className="d-flex">
                                                <img src={RetirementPeople} alt="RetirementPeople" title="RetirementPeople" className=""></img>
                                                <span className="total-employee">1,20L</span>
                                                <span className="plus-sign">+</span>
                                            </div>
                                            <p className="employee-tagline">retirement planning Users </p>
                                        </div>
                                    </Col>
                                    <Col sm={4}>
                                        <div className="employee-block">
                                            <div className="d-flex">
                                                <img src={UseingEmployee} alt="UseingEmployee" title="UseingEmployee" className=""></img>
                                                <span className="total-employee">1,5K</span>
                                                <span className="plus-sign">+</span>
                                            </div>
                                            <p className="employee-tagline">Employers using Life99 to plan</p>
                                        </div>
                                    </Col>
                                    <Col sm={4}>
                                        <div className="employee-block">
                                            <div className="d-flex">
                                                <img src={HappyEmployee} alt="HappyEmployee" title="HappyEmployee" className=""></img>
                                ...
                                <Row>
                                    <Col sm={3} className="text-center">
                                        <div className="qr-code-frame">
                                            <img src={Qrcode} alt="Qr-code" title="Qr-code" className="qrcode-img"></img>
                                        </div>
                                    </Col>
                                    <Col sm={7}>
                                        <div className='banner-download-application'>
                                            <p className='text-white'>Scan QR code to<br /> download the app</p>
